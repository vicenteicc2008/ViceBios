...
FT_BEGIN_HEADER
   ...
   *
   */
// Not supported on EDK.
// (Or perhaps we can support this via NVRAM?)
#if 0
...
/* #define FT_CONFIG_OPTION_SUBPIXEL_RENDERING */
   ...
   */
// The EDK2 build platform is probably supporting this.
#if 0
#undef FT_CONFIG_OPTION_FORCE_INT64
#else
#ifndef FT_CONFIG_OPTION_FORCE_INT64
